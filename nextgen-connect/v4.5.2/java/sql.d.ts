...
declare namespace java {
  namespace sql {
    ...
    interface Driver {
      ...
      connect(url: JString, info: java.util.Properties): Connection;
    ...
    interface Statement {
      ...
      executeQuery(sql: JString): ResultSet;

      /** Executes the given SQL statement, which may be an INSERT, UPDATE, or DELETE statement. */
      executeUpdate(sql: JString): int;
    ...
    class Timestamp extends java.util.Date {
      constructor(time: long);
      static valueOf(s: JString): Timestamp;
      getNanos(): int;
      setNanos(n: int): void;
    }
